{
	...
	"fileList": [
		...
		"media/aspose_خیابان.ogg",
		"media/aspose_دویدن_رخش.ogg",
		"media/aspose_شیهه_اسب.ogg",
		"media/aspose_صدای_خطا.ogg",
		"media/aspose_صدای_کلیک.ogg",
		"media/aspose_نقشه.ogg",
		"media/aspose_پس_زمینه.ogg",
		"media/صفحه شروع.ogg",
		"media/aspose_پیروزی.ogg",
		"media/aspose_horse_running_loop.ogg",
		"icon-16.png",
		"icon-32.png",
		"icon-114.png",
		"icon-128.png",
